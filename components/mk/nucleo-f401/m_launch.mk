...
.PHONY: launch
launch:
	@$(SOURCELIB_ROOT)/tools/vscode/generate_launch.py --debugger $(VSCODE_DEBUGGER)  --device $(JLINK_CPU) --elf $(shell pwd)/main.elf --dest $(REPO_ROOT)/.vscode --svd $(SOURCELIB_ROOT)/tools/vscode/STM32F401.svd
