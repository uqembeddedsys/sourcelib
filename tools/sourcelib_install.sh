...
wget -O $HOME/Downloads/JLink_Linux_V794j_x86_64.deb https://github.com/uqembeddedsys/sourcelib/releases/download/jlink/JLink_Linux_V794j_x86_64.deb
sudo dpkg -i $HOME/Downloads/JLink_Linux_V794j_x86_64.deb
